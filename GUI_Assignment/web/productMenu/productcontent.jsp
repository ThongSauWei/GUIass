                    ...
                    <div class="product-content-display-comment-container">
                        <div class="container">
                            ...
                            <div class="product-content-customer-detail-container">
                                ...
                                <h4 class="p-5 m-5"><%=view.getProductId()%><i class="bi bi-clipboard2-pulse"></i>Theres are no any comments yet</h4>
                                <%} else {%>
                                ...
                                <div class="row m-3">
                                    ...
                                    <div class="col-12 col-lg-8 col-md-8 col-xl-8">
                                        ...
                                        Member is Empty
                                        <%} else {%>
                                        <h5 class="product-content-customer-name"><%=memberList.get(h).getMemberId()%><%=memberList.get(h).getMemberName()%></h5>
                                        <%}%>
